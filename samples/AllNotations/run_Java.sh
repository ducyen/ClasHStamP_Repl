export ASTAH_HOME=~/$REPL_SLUG/astah-com_linux
export TOOL_DIR=~/$REPL_SLUG/release
export PROJECT=~/$REPL_SLUG/samples/AllNotations/Design.asta
export EXT_CODE_OPT=y
export ENCODING=UTF-8
export JAVA_TOOL_OPTIONS=-Dfile.encoding=UTF-8

export BAT_DIR=~/$REPL_SLUG
...
export OUTPUT=$SAMPLE_HOME/Java
export LANGUAGE=java
export SYNTAX=$TOOL_DIR/Syntax_Java.csv
export SYNTAX_BASECLASS=$TOOL_DIR/Syntax_Java.csv
export SYNTAX_INTERFACE=$TOOL_DIR/Syntax_JvIfc.csv
export SYNTAX_ABSTRACT=$TOOL_DIR/Syntax_JvAbs.csv
