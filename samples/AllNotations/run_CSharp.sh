...
export OUTPUT=$SAMPLE_HOME/CSharp
export LANGUAGE=cs
export SYNTAX=$TOOL_DIR/Syntax_CSharp.csv
export SYNTAX_BASECLASS=$TOOL_DIR/Syntax_CsBase.csv
export SYNTAX_INTERFACE=$TOOL_DIR/Syntax_CsIfc.csv
export SYNTAX_ABSTRACT=$TOOL_DIR/Syntax_CsAbs.csv
