...
export OUTPUT=$SAMPLE_HOME/Cpp
export LANGUAGE=cpp

export SYNTAX=$TOOL_DIR/Syntax_Hpp.csv
export SYNTAX_INTERFACE=$TOOL_DIR/Syntax_HppAbs.csv
export SYNTAX_ABSTRACT=$TOOL_DIR/Syntax_HppAbs.csv
export SYNTAX_BASECLASS=$TOOL_DIR/Syntax_Hpp.csv
...
export SYNTAX=$TOOL_DIR/Syntax_Cpp.csv
export SYNTAX_INTERFACE=$TOOL_DIR/Syntax_Cpp.csv
export SYNTAX_ABSTRACT=$TOOL_DIR/Syntax_Cpp.csv
export SYNTAX_BASECLASS=$TOOL_DIR/Syntax_Cpp.csv
